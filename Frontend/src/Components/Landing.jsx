      ...
      <div className='bg-black h-screen w-screen bg-no-repeat bg-cover ' style={{ backgroundImage: `url(${landing})` }}>
        <div className='text-white text-4xl pl-24 pt-6 h-24 bg-black bg-opacity-50 flex'>
          ...
          <h2 className='text-2xl mt-2 ml-60 cursor-pointer hover:text-white'>
            <Link to="/Loginpg" className="hover:underline hover:text-white">Login</Link>
          </h2>
          <h2 className='text-2xl mt-2 ml-20 cursor-pointer hover:text-white'>
            <Link to="/Signup" className="hover:underline hover:text-white">Sign up</Link>
          </h2>
          <div className=' h-10 w-10 border border-white rounded-3xl ml-20 '>
            <Link to='/Profile'><img src={spidey} className='bg-cover rounded-full' alt="" /></Link>
          </div>
              ...
              <Link to='/Blogs'>
                <div className="bg-red-950 p-5 rounded-lg">
                  <div className='w-full h-60 bg-blue-800'>
                    <img className='w-full h-full' src={blog.image_link} alt="" />
                  </div>
                  <h2 className='text-xl font-bold text-white'>{blog.title}</h2>
                  <p className='text-md line-clamp-3 text-white'>{blog.description}</p>
                </div>
              </Link>
            ))}
          </div>
